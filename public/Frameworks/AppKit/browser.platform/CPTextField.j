i;11;CPControl.ji;17;CPStringDrawing.jc;31335;
...
{ with(self)
{
    ...
    if ((!string || objj_msgSend(string, "length") === 0) && !(_controlState & CPControlStateEditing))
...
{ with(self)
{
    var size = objj_msgSend((objj_msgSend(self, "stringValue") || " "), "sizeWithFont:", objj_msgSend(self, "font")),
...
{ with(self)
{
    if (!CPTextFieldDOMInputElement)
    {
        ...
        {
            objj_msgSend(CPTextFieldInputOwner, "setObjectValue:", anElement.value);
            if (anEvent && anEvent.keyCode == CPReturnKeyCode)
            {
                objj_msgSend(CPTextFieldInputOwner, "sendAction:to:", objj_msgSend(CPTextFieldInputOwner, "action"), objj_msgSend(CPTextFieldInputOwner, "target"));
                objj_msgSend(objj_msgSend(CPTextFieldInputOwner, "window"), "makeFirstResponder:", nil);
                CPTextFieldInputOwner = nil;
            }
            ...
            {
                if (!anEvent.shiftKey)
                    objj_msgSend(objj_msgSend(CPTextFieldInputOwner, "window"), "selectNextKeyView:", CPTextFieldInputOwner);
                else
                    objj_msgSend(objj_msgSend(CPTextFieldInputOwner, "window"), "selectPreviousKeyView:", CPTextFieldInputOwner);
            }
            else
            {
                var obj = CPTextFieldInputOwner;
                CPTextFieldInputOwner = nil;
                objj_msgSend(objj_msgSend(obj, "window"), "makeFirstResponder:", nil);
            }
            objj_msgSend(objj_msgSend(CPRunLoop, "currentRunLoop"), "limitDateForMode:", CPDefaultRunLoopMode);
        }
