I;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jI;33;Foundation/CPNotificationCenter.jI;21;Foundation/CPString.ji;15;CPApplication.ji;12;CPClipView.ji;12;CPMenuItem.ji;9;CPPanel.jc;62008;
...
{ with(self)
{
    ...
    {
        objj_msgSend(_CPMenuBarAttributes, "setObject:forKey:", objj_msgSend(CPColor, "colorWithWhite:alpha:", 1.0, 0.8), "CPMenuBarTextShadowColor");
        objj_msgSend(_CPMenuBarAttributes, "setObject:forKey:", objj_msgSend(CPColor, "colorWithWhite:alpha:", 1.0, 0.8), "CPMenuBarTitleShadowColor");
    }
    if (!highlightColor)
        objj_msgSend(_CPMenuBarAttributes, "setObject:forKey:", objj_msgSend(CPColor, "colorWithCalibratedRed:green:blue:alpha:", 81.0 / 255.0, 83.0 / 255.0, 109.0 / 255.0, 1.0), "CPMenuBarHighlightColor");
...
{ with(self)
{
    ...
    if (!_highlightView)
    {
        ...
        objj_msgSend(_highlightView, "setBackgroundColor:", _highlightColor);
    }
    else
