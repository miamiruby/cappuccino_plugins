I;20;Foundation/CPArray.jI;26;Foundation/CPObjJRuntime.ji;19;CGAffineTransform.ji;12;CGGeometry.ji;9;CPColor.ji;20;CPDOMDisplayServer.ji;12;CPGeometry.ji;19;CPGraphicsContext.ji;13;CPResponder.ji;9;CPTheme.jc;47829;
CPViewNotSizable = 0;
CPViewMinXMargin = 1;
...
var meta_class = the_class.isa;class_addMethods(the_class, [new objj_method(sel_getUid("canBecomeKeyView"), function(self, _cmd)
{ with(self)
{
...
{ with(self)
{
    ...
    objj_msgSend(aCoder, "encodeConditionalObject:forKey:", objj_msgSend(self, "nextKeyView"), CPViewNextKeyViewKey);
    objj_msgSend(aCoder, "encodeConditionalObject:forKey:", objj_msgSend(self, "previousKeyView"), CPViewPreviousKeyViewKey);
    for (var attributeName in _themedAttributes)
        if (_themedAttributes.hasOwnProperty(attributeName))
