I;20;Foundation/CPCoder.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.jI;16;AppKit/CPImage.jI;15;AppKit/CPMenu.jI;15;AppKit/CPView.jc;28316;
...
}), new objj_method(sel_getUid("setActivateColor:"), function(self, _cmd, aColor)
{ with(self)
{
    _activateColor = aColor;
}
}), new objj_method(sel_getUid("activateColor"), function(self, _cmd)
{ with(self)
{
    return _activateColor;
}
}), new objj_method(sel_getUid("setActivateShadowColor:"), function(self, _cmd, aColor)
{ with(self)
{
    _activateShadowColor = aColor;
}
}), new objj_method(sel_getUid("activateShadowColor"), function(self, _cmd)
{ with(self)
{
